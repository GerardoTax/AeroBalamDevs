...
public class ManejadorDeTablaHistorial {
     public static void llenarTabla(ArrayList<Pasaporte> lispasaporte, JTable table) {
        ...
        for (Pasaporte pasaporte : lispasaporte) {
            modelo.addRow(new Object[]{pasaporte.getNoPasaporte(),pasaporte.getContrasella(),pasaporte.getFechaNacimiento(),pasaporte.getNacionalidad(),pasaporte.getEstadoCivil(),
