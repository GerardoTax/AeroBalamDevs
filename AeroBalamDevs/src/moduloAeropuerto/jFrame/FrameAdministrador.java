...
public class FrameAdministrador extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int contraseña= Integer.valueOf(this.jTextField2.getText());
        String tipo= (String) this.jComboBox1.getSelectedItem();
        Personal personal=new Personal(usuario,contraseña,tipo);
        //incico uuna nueva arraylist
        ArrayList<Personal> lisPersonal = new ArrayList<>();
        //le ingreso un objeto a mi arraylist
        ...
        try {
         ...
         try {
           ArrayList<Personal>  lispersona= this.lectorEscrituraBinariosPersonal.leerPersonal();
           System.out.println("*********");
            System.out.println(lispersona.get(0).getUsuario()+"   "+lispersona.get(0).getPuesto());
         } catch (IOException ex) {
